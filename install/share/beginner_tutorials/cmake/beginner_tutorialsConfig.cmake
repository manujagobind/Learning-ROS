...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'beginner_tutorials' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/gobind/Workspace/ROS_Tutorials/install/${idir}'.  Ask the maintainer 'Gobind Manuja <manujagobind@gmail.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/gobind/Workspace/ROS_Tutorials/install/lib;/home/gobind/Workspace/ROS_Tutorials/devel/lib;/opt/ros/indigo/lib)
